...
This table successfully shows us all the tweets we acquired, which is a total of 4,542. The variables I chose to describe them include the ID number, the text of the tweet, how many times it was favorited, how many times it was retweeted, latitude and longitude, and which biased term was in the tweet [@7.tidyi].
