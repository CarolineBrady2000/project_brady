...
Next we'll save our map for tweets with geolocation for location analysis.

```{r save-second-dataset}
save_as_csv(tweets_map, file_name = "../data/original/tweets_map.csv") #save the transformed data results as a csv file
```
